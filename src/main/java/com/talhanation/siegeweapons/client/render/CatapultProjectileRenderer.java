...
import com.talhanation.siegeweapons.client.models.CatapultProjectileModel;
...
public class CatapultProjectileRenderer extends EntityRenderer<CatapultProjectile> {

    private static final ResourceLocation[] TEXTURE = {
            new ResourceLocation(Main.MOD_ID,"textures/entity/catapult_projectile.png")
    };
    ...
    @Override
    public ResourceLocation getTextureLocation(CatapultProjectile entity) {
        return TEXTURE[0];
    }
    private final CatapultProjectileModel model = new CatapultProjectileModel();
    @Override
    public void render(CatapultProjectile entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource multiBufferSource, int packedLight) {
        poseStack.pushPose();
