...
public class ModTexts {
    ...
    public static Component VEHICLE_WASD = Component.translatable("text.siegeweapons.catapult_controls");
    public static Component VEHICLE_LOAD_SHOOT = Component.translatable("text.siegeweapons.catapult_controls");
